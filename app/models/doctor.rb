class Doctor < ApplicationRecord
  ...
  def get_all_available_time_slots
    time_slots = {}
    gen_time_slots = general_day_time_slots
    sql_query_string = "SELECT start_timestamp FROM appointments WHERE start_timestamp >= current_timestamp and doctor_id = #{self.id} ORDER BY start_timestamp;"
